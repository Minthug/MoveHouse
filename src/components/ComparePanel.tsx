    ...
    <div>
      <form onSubmit={handleSubmit} className="flex gap-1.5">
        <input
          ...
          className="min-w-0 flex-1 text-[16px] lg:text-xs border border-gray-200 rounded-lg px-3 py-1.5 outline-none focus:border-gray-400 bg-white"
        />
        <button
          type="submit"
          disabled={loading}
...
export default function ComparePanel({
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 border-l-0 border-gray-200 pb-[calc(58px+env(safe-area-inset-bottom))] lg:border-l lg:pb-0">
      {/* Header */}
      <div className="p-3 lg:p-4 bg-white border-b border-gray-200">
        <div className="flex flex-wrap items-center justify-between gap-1.5 lg:gap-2 mb-2 lg:mb-3">
          <button
            onClick={onBackHome}
          ...
          <div className="flex flex-wrap items-center justify-end gap-1.5 lg:gap-2 shrink-0">
            {themeToggle}
      ...
      {/* Destination section */}
      <div className="p-3 lg:p-4 bg-white border-b border-gray-200 space-y-2">
      ...
      {/* Candidate search */}
      {destination && (
        <div className="p-3 lg:p-4 border-b border-gray-200 bg-white space-y-2">
      ...
      <div className="flex-1 overflow-y-auto p-3 lg:p-4 space-y-2 lg:space-y-3">
        ...
        {canCompare && (
          <button
            ...
            className="w-full mt-1 py-2.5 lg:py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold transition-colors flex items-center justify-center gap-2 shadow-sm"
          >
            📊 비교 분석하기
          </button>
        )}
